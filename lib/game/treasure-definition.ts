...
export const BUNDLED_TREASURE_DEFINITIONS: TreasureDefinition[] = [
  ...
  { id: "green-dragon-blade", name: "청룡언월도", category: "weapon", grade: "A", allowedUnitTypes: ["cavalry"], effectKind: "attack", effectValue: 12, terrainBonuses: [], history: "관우의 무기로 널리 알려진 언월도입니다.", description: "관우의 이름과 함께 전해지는 언월도." },
  ...
  { id: "arabian-horse", name: "아라비아마", category: "mount", grade: "S", allowedUnitTypes: [], effectKind: "movement", effectValue: 3, terrainBonuses: ["plain", "forest"], history: "아라비아 반도에서 오랫동안 길러진 지구력 높은 말 품종입니다.", description: "긴 여정을 버티는 지구력 높은 명마." },
  { id: "akhal-teke", name: "아할테케", category: "mount", grade: "SS", allowedUnitTypes: [], effectKind: "movement", effectValue: 4, terrainBonuses: ["plain", "forest", "hill"], history: "중앙아시아 투르크메니스탄에서 이어져 온 오래된 말 품종입니다.", description: "황금빛 털로 알려진 중앙아시아의 최고급 명마." },
