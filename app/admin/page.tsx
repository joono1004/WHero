...
const TROOP_SPRITES: Record<TroopAction, { source: string; rows: number; ratio: number; fps: number }> = {
  ready: { source: "/art/units/infantry-frames/ready-v1.png", rows: 3, ratio: 0.75, fps: 3 },
  move: { source: "/art/units/infantry-frames/move-v1.png", rows: 3, ratio: 0.75, fps: 6 },
  attack: { source: "/art/units/infantry-frames/attack-v1.png", rows: 6, ratio: 1.15, fps: 9 },
  hurt: { source: "/art/units/infantry-frames/hurt-v1.png", rows: 3, ratio: 1, fps: 4 },
  death: { source: "/art/units/infantry-frames/death-v1.png", rows: 3, ratio: 1, fps: 3 },
};
  ...
  return <section className="admin-content admin-troop-preview"><style>{`.admin-troop-preview{min-height:620px}.troop-preview__layout{display:grid;grid-template-columns:minmax(460px,1fr) 270px;gap:22px;padding-top:22px}.troop-preview__stage{position:relative;min-height:500px;overflow:hidden;border:1px solid #8f6c36;border-radius:8px;background:radial-gradient(ellipse at 50% 55%,#50613b 0 15%,#30422f 16% 30%,#17251f 55%,#0b120f 100%);box-shadow:inset 0 0 50px #000a}.troop-preview__map-hex{position:absolute;width:176px;aspect-ratio:1/.866;border:2px solid #b7994b99;background:linear-gradient(135deg,#78945d9b,#3d583c9b);clip-path:polygon(50% 0,100% 25%,100% 75%,50% 100%,0 75%,0 25%);filter:drop-shadow(0 1px 0 #111)}.troop-preview__map-hex--lu{left:calc(50% - 176px);top:34px}.troop-preview__map-hex--ru{left:50%;top:34px}.troop-preview__map-hex--l{left:calc(50% - 264px);top:155px}.troop-preview__map-hex--c{left:calc(50% - 88px);top:155px;background:linear-gradient(135deg,#9a9b51bb,#52693cbf);border-color:#f2d474}.troop-preview__map-hex--r{left:calc(50% + 88px);top:155px}.troop-preview__map-hex--ld{left:calc(50% - 176px);top:276px}.troop-preview__map-hex--rd{left:50%;top:276px}.troop-preview__unit{position:absolute;z-index:2;left:50%;top:56px;width:min(290px,48%);aspect-ratio:var(--sprite-ratio);background-image:var(--sprite-image);background-repeat:no-repeat;background-size:600% var(--sprite-size-y);background-position:var(--sprite-x) var(--sprite-y);filter:drop-shadow(0 10px 8px #000b)}.troop-preview__unit.is-move{animation:troop-move .5s ease-in-out infinite}.troop-preview__unit.is-attack{animation:troop-attack .65s ease-in-out infinite}.troop-preview__unit.is-hurt{animation:troop-hurt .75s ease-in-out infinite}.troop-preview__unit.is-death{animation:troop-death 1.4s ease-in forwards}.troop-preview__caption{position:absolute;z-index:3;bottom:20px;left:50%;translate:-50% 0;border:1px solid #bd9650;border-radius:4px;background:#140d08d9;color:#ffe5a2;padding:7px 13px;font-size:13px;font-weight:900}.troop-preview__controls{display:grid;align-content:start;gap:18px;padding:18px;border:1px solid #846331;border-radius:7px;background:#160d08c9}.troop-preview__controls section{border-bottom:1px solid #875e2b;padding-bottom:16px}.troop-preview__controls h3{margin:0 0 10px;color:#f2cb75;font-size:14px}.troop-preview__buttons{display:grid;grid-template-columns:repeat(2,1fr);gap:6px}.troop-preview__buttons button{border:1px solid #76522a;border-radius:4px;background:#28150a;color:#d9b97a;padding:8px 5px;font-size:12px}.troop-preview__buttons button.is-active{border-color:#f0c65e;background:linear-gradient(#8b5b25,#42210e);color:#fff0bc}.troop-preview__controls p{margin:0;color:#b99d70;font-size:12px;line-height:1.6}@keyframes troop-move{0%,100%{translate:-50% 0}50%{translate:calc(-50% + var(--troop-x)*18px) calc(var(--troop-y)*-14px)}}@keyframes troop-attack{0%,100%{translate:-50% 0}55%{translate:calc(-50% + var(--troop-x)*42px) calc(var(--troop-y)*-26px)}}@keyframes troop-hurt{0%,100%{translate:-50% 0;filter:drop-shadow(0 10px 8px #000b)}50%{translate:calc(-50% - var(--troop-x)*7px) 15px;filter:brightness(.68) drop-shadow(0 10px 8px #000b)}}@keyframes troop-death{0%{translate:-50% 0;opacity:1}78%{translate:calc(-50% + var(--troop-x)*24px) 105px;opacity:1}100%{translate:calc(-50% + var(--troop-x)*24px) 105px;opacity:0}}@media(max-width:800px){.troop-preview__layout{grid-template-columns:1fr}.troop-preview__controls{grid-row:1}.troop-preview__stage{min-height:440px}.troop-preview__map-hex{width:136px}.troop-preview__map-hex--lu{left:calc(50% - 136px);top:30px}.troop-preview__map-hex--ru{left:50%;top:30px}.troop-preview__map-hex--l{left:calc(50% - 204px);top:124px}.troop-preview__map-hex--c{left:calc(50% - 68px);top:124px}.troop-preview__map-hex--r{left:calc(50% + 68px);top:124px}.troop-preview__map-hex--ld{left:calc(50% - 136px);top:218px}.troop-preview__map-hex--rd{left:50%;top:218px}}`}</style>
    ...
    <div className="troop-preview__layout">
      <div className="troop-preview__stage" aria-label={`${currentDirection.label} 방향 ${TROOP_ACTION_LABEL[action]} 보병 프레임 시연`}>
        ...
        <div className={`troop-preview__unit is-${action}`} style={previewStyle} aria-label={`${frame + 1}번째 프레임`} />
      ...
      <div className="troop-preview__controls">
        ...
        <p>준비·이동·피해는 3프레임, 공격은 6프레임, 사망은 3프레임 뒤 사라집니다. 모든 프레임은 별도 이미지 자산입니다.</p>
      </div>
    </div>
  </section>;
}
